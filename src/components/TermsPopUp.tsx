...
const TermsPopUp = () => {
  return (
    <div className="screen-container">
      ...
      <div className="terms-pop-container">
        <div className="title-card">
          <h3>Terms of Use</h3>
          <div className="terms-close-button-container">
            <CloseIcon className="terms-close-button" />
          </div>
        </div>
        <div className="terms-content">
          <h4>OVERVIEW</h4>
          This website is operated by ula. Throughout the site, the terms “we”,
          “us” and “our” refer to ula. ula offers this website, including all
          ...
          POLICY] We have made every effort to display as accurately as possible
          ...
          limit the sales of our products or Services to any person, geographic
          ...
          <h4>SECTION 8 - THIRD-PARTY LINKS </h4>Certain content, products and
          ...
          <h4>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h4> If,
          ...
          <h4>SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY </h4>We do not guarantee, represent or warrant that
          ...
          from the use of the service will be accurate or reliable. You agree
          ...
          case shall ula, our directors, officers, employees, affiliates,
          ...
          <h4>SECTION 14 - INDEMNIFICATION</h4> You agree to indemnify, defend and hold harmless ula
          ...
          <h4>SECTION 15 - SEVERABILITY</h4> In the event that any provision of these Terms of Service
          ...
          provisions. 
          <h4>SECTION 16 - TERMINATION</h4> The obligations and liabilities
          ...
          <h4>SECTION 17 - ENTIRE AGREEMENT</h4> The failure of us to exercise or enforce any right or
          ...
          <h4>SECTION 18 - GOVERNING LAW</h4> These Terms of
          Service and any separate agreements whereby we provide you Services
          shall be governed by and construed in accordance with the laws of
          Canada. 
          <h4>SECTION 19 - CHANGES TO TERMS OF SERVICE</h4> You can review the
          ...
          <h4>SECTION 20 - CONTACT INFORMATION</h4> Questions about the Terms of Service should be
          sent to us at ethan_mcfarland@outlook.com. Our contact information is
          posted below: [INSERT TRADING NAME] [INSERT EMAIL ADDRESS] [INSERT
          BUSINESS ADDRESS] [INSERT BUSINESS PHONE NUMBER] [INSERT BUSINESS
          REGISTRATION NUMBER] [INSERT VAT NUMBER]
        </div>
      </div>
    </div>
  );
