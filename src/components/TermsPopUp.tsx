    ...
    <div className="screen-container">
      ...
      >
        <div className="title-card">
          <h3>Terms of Use</h3>
          <div
            className="terms-close-button-container"
        ...
        <div className="terms-content">
          ...
          non-infringement. In no case shall ula, our directors, officers,
          ...
          <h4>SECTION 14 - INDEMNIFICATION</h4> You agree to indemnify, defend
          and hold harmless ula and our parent, subsidiaries, affiliates,
          ...
          <h4>SECTION 15 - SEVERABILITY</h4> In the event that any provision of
          ...
          <h4>SECTION 16 - TERMINATION</h4> The obligations and liabilities of
          ...
          (or any part thereof).
          <h4>SECTION 17 - ENTIRE AGREEMENT</h4> The failure of us to exercise
          ...
          <h4>SECTION 18 - GOVERNING LAW</h4> These Terms of Service and any
          separate agreements whereby we provide you Services shall be governed
          ...
          <h4>SECTION 20 - CONTACT INFORMATION</h4> Questions about the Terms of
          Service should be sent to us at ethan_mcfarland@outlook.com. Our
          contact information is posted below: [INSERT TRADING NAME] [INSERT
          EMAIL ADDRESS] [INSERT BUSINESS ADDRESS] [INSERT BUSINESS PHONE
          NUMBER] [INSERT BUSINESS REGISTRATION NUMBER] [INSERT VAT NUMBER]
        </div>
      </div>
    </div>
  );
